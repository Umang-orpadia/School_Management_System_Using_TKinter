...
def first_window():
    ...
    def register_window():
        ...
        options = ['student','teac']
        your_role = StringVar()
        your_role.set('student')

        user_role = OptionMenu(root1 , your_role , *options )
        user_role.grid(row = 9 , column = 1 , padx = 20 , pady = 20)
        ...
        temp = Button(root1 , text='try' , command=trying)
        temp.grid(row=10 , column=1)
        root1.mainloop()

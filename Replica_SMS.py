        ...
        if enteredusername == 'admin' and enteredpassword == 'admin':
            def admin_window_function():
                ...
                def admin_college_register_function():
                    ...
                    labelthisas(admin_college_register_window,'Name of Institute',0,0)
                    name_of_college_entry = entryfunction(admin_college_register_window,0,1)
                    labelthisas(admin_college_register_window,'E-mail of Institute',1,0)
                    email_of_college_entry = entryfunction(admin_college_register_window,1,1)
                    labelthisas(admin_college_register_window,'Contact No. of Institute',2,0)
                    contact_of_college_entry = entryfunction(admin_college_register_window,2,1)
                    labelthisas(admin_college_register_window,'Branch Name of Institute',3,0)
                    branch_of_college_entry = entryfunction(admin_college_register_window,3,1)
                    labelthisas(admin_college_register_window,'Address of Institute',4,0)
                    address_of_college_entry = entryfunction(admin_college_register_window,4,1) 
                    labelthisas(admin_college_register_window,'Set password',5,0)
                    password_of_college_entry = entryfunction(admin_college_register_window,5,1)
